...
/**
 * @ClassName: CnToCharParser
 * @Description: TODO
 * @author: steven zhang
 * @date: Sep 27, 2016 2:32:03 PM
 */
public class CnToCharParser {

    private static Map<String, Integer> spellMap = null;
    private static Map<Character, String> uncommonWordsMap = null;
    private static CnToCharParser cnParser = new CnToCharParser();
    static {
        if (spellMap == null) {
    ...
    private CnToCharParser() {

    }

    public static CnToCharParser getInstance() {
        return cnParser;
    }
            ...
            if (ascii == 0) { 
                ...
                if (spell == null || spell.length() == 0) { 
                    ...
                    if (onlyFirstSpell) {
                        ...
                        sb.append((spell.startsWith("'")&&spell.length()>1) ? spell.substring(1)
                                : spell.substring(0));
                    }
                }
            }
